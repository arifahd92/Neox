...
export default function Main() {
  return (
    <>
      ...
      {/* """""""""""""""""""""""""""""""""""""""""""""""""*/}
      <div className="container " id="about" style={{ marginTop: "170px" }}>
        <div className="row">
        ...
        <div className="row  d-flex justify-content-between">
          <div className="col-md-6 " style={{ height: "fit-content" }}>
            ...
            <div
              ...
              Since 2014, Maharashtra LTD is a{" "}
              <span
                className="text"
                style={{ color: "rgb(206, 170, 88)", opacity: "1" }}>
                construction business{" "}
              </span>
              with futuristic business analytics.
            </div>
            <div
